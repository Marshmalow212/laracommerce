...
<!--                            --><?//=$_SESSION['user_id'];?>
                        ...
                        <div class="col-md-6 offset-2">
                            <ul class="nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/register"><i class="far fa-comments"></i> Sign up</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-sm-3">
                        <div class="logo">
                            <a href="/" class="navbar-brand">
                                <img src="assets/img/logo.png" alt="logo.png" class="">
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ecommerceNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/products">LIVING ROOM</a>
                    </li>
                    <li class="nav-item">
