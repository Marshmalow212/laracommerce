...
<section id="create__form">
    <div class="container">
        <div class="row col-md-6">
            <h1 class="text-center mb-4 mt-2">Update Form</h1>
            ...
            <form method="post" action={{route('sliders.update',$slider->id)}} enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputTitle" name="subtitle" value="{{$slider->subtitle}}">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputTitle" name="price" value="{{$slider->price}}">
                    </div>
                </div>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="{{$slider->status}}" id="inputActive" name="status">
